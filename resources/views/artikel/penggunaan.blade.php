...
<head>
    ...
    <title>Kelompok Prakerin 36 | Penggunaan</title>
    <style>
    .navbar-brand{
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="#">Penggunaan |</a>
              </li>
              <li class="nav-item">
...
<div class="container">
  <div class="text-center">
    <p class="judul">PENGGUNAAN INTERNET DALAM BERBISNIS</p>
  </div>
  <img src="img/gambar2.jpg" style="width: 50%; margin-top: 10px; margin-left: 270px;">
  <div class="art">
    <p>Penggunaan internet dalam bisnis mengalami perkembangan, dari pertukaran
      informasi secara elektronik ke aplikasi strategi bisnis, seperti: 
    <ul class="art">
    <li>pemasaran</li>
    <li>penjualan</li>
    <li>pelayanan pelanggan.</li>
    </ul></p>
     <p class="art"> Internet mendukung komunikasi dan kerja sama global antara pegawai,
     ...
     <p class="art"> Dengan internet memungkinkan aplikasi Electronic Commerce (EC) dapat
