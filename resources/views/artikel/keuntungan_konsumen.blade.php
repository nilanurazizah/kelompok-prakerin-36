...
<head>
    ...
    <title>Kelompok Prakerin 36 | Keuntungan Konsumen</title>
    <style>
        .navbar-brand{
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="#">Keuntungan yang diperoleh konsumen |</a>
              </li>
              <li class="nav-item">
      ...
      <div class="container">
        <div class="text-center">
          <p class="judul">APA SAJA KEUNTUNGAN YANG DIPEROLEH KONSUMEN DARI INTERNET ?</p>
        </div>
        <div class="art">
          <p>“The driving force behind world economic growth has changed from
            manufacturing volume to improving konsumen value. As a result, the key success factor for many firms is maximizing konsumen value” (Cronin, 1995). Untuk beberapa
          ...
          <p>
            Dari sudut pandang konsumen, perusahaan secara konsisten dapat memberikan yang terbaik,
          ...
          <p>
            kebutuhan konsumen berkembang sangat cepat, perusahaan berharap dapat berkomunikasi dengan konsumennya lewat internet.
